...
layer. I take ambiguous scientific problems from first principles to working implementation,
...
revised, results published between one release and the next. A fixed pipeline has no way to
